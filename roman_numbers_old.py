'''
Перевод числа, написанного арабскими цифрами в римские.
num - Исходное число
'''
...
def rom(num: int):
    ...
    #     raise SystemExit('Это значение не конвертируемо') #Верно ли сделал остановку при ошибке, что делать с числом 01?
    assert 0 < num < 1000, 'M - и все на этом'     #Хотелось бы останавливать прогу просто, без большого ответа от интерпр.
    # if num >= 1000:
    #     raise SystemExit('M - и все на этом')
